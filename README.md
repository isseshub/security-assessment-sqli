...
Detta labb demonstrerar hur en SQL Injection-sårbarhet kan påverka ett
kreditbeslut baserat på UC-liknande kreditdata, samt hur sårbarheten
åtgärdas med säkra kodningsprinciper.
...
Detta projekt är avsett för utbildningssyfte och ska endast köras i
isolerad lokal miljö.
